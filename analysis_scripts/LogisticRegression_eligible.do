...
/* Create log file */
capture log close
log using analysis_logs/LogisticRegression_eligible, smcl replace
...
table (age_cat gender imd2015_5 ethnicity) (eligible) (region), statistic(percent) //statistic(mean age)
...
forvalues eng_region = 1/10 {
	...
	logit eligible i.age_cat i.gender i.imd2015_5 i.ethnicity if region == `eng_region', base
}


log close
translate analysis_logs/LogisticRegression_eligible.smcl ///
		  outputs/LogisticRegression_eligible.pdf