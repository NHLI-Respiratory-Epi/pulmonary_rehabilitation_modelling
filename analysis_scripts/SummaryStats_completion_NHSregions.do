//=============================================================================+
//      SUMMARY STATISTICS -- COMPLETION IN 1 YEAR FOR THOSE WHO COMMENCED     |
//=============================================================================+
clear all
set more off
...
/* Create log file */
capture log close
log using analysis_logs/SummaryStats_completion_NHSregions, text replace
...
//Outcomes
tab1 completed
bysort nhs_region: tab1 completed



log close
/*translate analysis_logs/SummaryStats_completion_NHSregions.smcl ///
		  outputs/SummaryStats_completion_NHSregions.pdf*/