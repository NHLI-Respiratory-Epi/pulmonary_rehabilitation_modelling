...
/* Create log file */
capture log close
log using analysis_logs/LogisticRegression_completion_NHSregions, smcl replace
...
table (age_cat gender imd2015_5 ethnicity) (completed) (nhs_region), statistic(percent) //statistic(mean age)
...
forvalues eng_region = 1/7 {
	...
	logit completed i.age_cat i.gender i.imd2015_5 i.ethnicity if nhs_region == `eng_region', base
}


log close
translate analysis_logs/LogisticRegression_completion_NHSregions.smcl ///
		  outputs/LogisticRegression_completion_NHSregions.pdf