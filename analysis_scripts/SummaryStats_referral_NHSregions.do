//=============================================================================+
//     SUMMARY STATISTICS -- REFERRAL IN 1 YEAR FOR THOSE WHO ARE ELIGIBLE     |
//=============================================================================+
clear all
set more off
...
/* Create log file */
capture log close
log using analysis_logs/SummaryStats_referral_NHSregions, text replace
...
//Outcomes
tab1 referred
bysort nhs_region: tab1 referred



log close
/*translate analysis_logs/SummaryStats_referral_NHSregions.smcl ///
		  outputs/SummaryStats_referral_NHSregions.pdf*/