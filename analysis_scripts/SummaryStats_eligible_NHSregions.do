//=============================================================================+
//         SUMMARY STATISTICS -- ELIGIBLE IN 1 YEAR FOR THOSE WHO ARE          |
//                             DIAGNOSED WITH COPD                             |
//=============================================================================+
clear all
set more off
...
/* Create log file */
capture log close
log using analysis_logs/SummaryStats_eligible_NHSregions, text replace
...
//Outcomes
tab1 eligible
bysort nhs_region: tab1 eligible



log close
/*
//Convert Stata log to PDF
translate analysis_logs/SummaryStats_eligible_NHSregions.smcl ///
		  outputs/SummaryStats_eligible_NHSregions.pdf

//Convert Stata log to text
translate analysis_logs/SummaryStats_eligible_NHSregions.smcl ///
		  outputs/SummaryStats_eligible_NHSregions.log, translator(smcl2log) replace*/